...
--config-file dinov2/configs/train/vitl16_ibot333_highres336.yaml \
--output-dir /fast/yangz16/outputs/chexfound/ibot333_highres336 \
...
&> /fast/yangz16/outputs/chexfound/ibot333_highres336.log &